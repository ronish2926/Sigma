...
public class BarChart extends FrameLayout {
    ...
    private void updateUi(int position, int dimension, BarChartModel barChartModelInit,
        ...
        if (isShowBarValue) {
            ...
            TextView txtXBar = view.findViewById(R.id.txt_xbar);
            ...
            if (barChartModel.getBarXValue()!=null){
                txtXBar.setText(barChartModel.getBarXValue());
            }

            textView.setTextSize(barTextSize);
            textView.setTextColor(barTextColor);

            txtXBar.setTextSize(barTextSize);
            txtXBar.setTextColor(barTextColor);
