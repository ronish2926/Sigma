...
package com.haris.kareem_driver.JsonUtil.CategoryUtil;
...
public class CategoryJson implements Parcelable
{
    ...
    protected CategoryJson(Parcel in) {
        ...
        in.readList(this.categories, (com.haris.kareem_driver.JsonUtil.CategoryUtil.Category.class.getClassLoader()));
    }
