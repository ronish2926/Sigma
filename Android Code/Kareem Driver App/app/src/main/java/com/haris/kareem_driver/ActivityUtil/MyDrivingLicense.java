...
public class MyDrivingLicense extends AppCompatActivity implements View.OnClickListener, ConnectionCallback {
    private String TAG = MyDrivingLicense.class.getSimpleName();
    ...
    private String document_type = "driving_license";
    ...
    private void initUI() {
        ...
        txtMenu.setText(Utility.getStringFromRes(this, R.string.driving_license));
        ...
        txtDocumentType.setText(Utility.getStringFromRes(this,R.string.driving_license));
    ...
    private String getJson(String rider_id) {
        ...
        try {
            ...
            jsonObject.accumulate("functionality", "retrieve_driving_license");
