...
public class MyCarDocuments extends AppCompatActivity implements View.OnClickListener, ConnectionCallback {
    private String TAG = MyCarDocuments.class.getSimpleName();
    ...
    private String document_type = "car_documents";
    ...
    private void initUI() {
        ...
        txtMenu.setText(Utility.getStringFromRes(this, R.string.car_documents));
        ...
        txtDocumentType.setText(Utility.getStringFromRes(this,R.string.car_documents));
    ...
    private String getJson(String rider_id) {
        ...
        try {
            ...
            jsonObject.accumulate("functionality", "retrieve_car_documents");
