...
public class MyCarPictures extends AppCompatActivity implements View.OnClickListener, ConnectionCallback {
    private String TAG = MyCarPictures.class.getSimpleName();
    ...
    private String document_type = "car_pictures";
    ...
    private void initUI() {
        ...
        txtMenu.setText(Utility.getStringFromRes(this, R.string.car_pictures));
        ...
        txtDocumentType.setText(Utility.getStringFromRes(this,R.string.car_pictures));
    ...
    private String getJson(String rider_id) {
        ...
        try {
            ...
            jsonObject.accumulate("functionality", "retrieve_car_pictures");
