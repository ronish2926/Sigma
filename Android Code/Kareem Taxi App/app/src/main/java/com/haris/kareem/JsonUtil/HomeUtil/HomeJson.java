...
public class HomeJson implements Parcelable
{
    ...
    protected HomeJson(Parcel in) {
        ...
        in.readList(this.featured, (com.haris.kareem.JsonUtil.HomeUtil.Featured.class.getClassLoader()));
        in.readList(this.trending, (com.haris.kareem.JsonUtil.HomeUtil.Trending.class.getClassLoader()));
        in.readList(this.nearest, (com.haris.kareem.JsonUtil.HomeUtil.Nearest.class.getClassLoader()));
    }
