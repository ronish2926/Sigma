            ...
            <div class="row">
                <div class="col-xl-4 offset-xl-4">
                    ...
                    $decryption=openssl_decrypt ($row['password'], $ciphering,
                        $row['encryption_key'], $options, $row['encryption_text']);

                    ?>
                    <div class="card profile_update_card">
                        <div class="card-body">
                            <form role="form" method="post" action="update-action.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="">Email</label>
                                    <input type="text" name="email" id="" class="form-control" value="<?=$row['username'];?>" placeholder="Enter Email" aria-describedby="helpId">
                                </div>
                                <div class="form-group">
                                    <label for="password_id">Password</label>
                                    <input type="password" name="password_id" id="password_id" value="<?=$decryption;?>" class="form-control " placeholder="Enter Password" aria-describedby="helpId">
