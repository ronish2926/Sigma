...
<!--                                                                class="fas fa-angle-right"></i></span></a></li>-->
                                        ...
                                        <form action="#">
                                            <div class="input-group ">
                                                ...
                                                <input type="text" class="form-control" placeholder="Searching for.."
                                                    aria-label="Username" id="captain-search" aria-describedby="basic-addon1">
                                            </div>
                                        </form>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="captain-table-body-id">
                                            <tr>
                                                ...
                                                <td>45252</td>
                                                <td>$245252</td>
                                                <td><span class="span_reject">Reject</span></td>
                                                <td>4.5</td>
        ...
        <script>
            ...
            $(".sidebar_rejected").addClass("active");
        </script>
                            ...
                            if (data.code == "202") {
                                ...
                                for (var i = 0; i < list.length; i++) {
                                    ...
                                    var text = "<tr id=\"captains-row-"+n+"\">\n" +
                                        ...
                                        "                                                <td>"+total_trips+"</td>\n" +
                                        "                                                <td>"+total_revenue+"</td>\n" +
                                        "                                                <td><span  class=\"span_reject\">Rejected</span></td>\n" +
                                        "                                                <td>"+avg_rating+"</td>\n" +
                                        "                                                <td><a href=\"driver_detail.php?id="+n+"\"><span class=\"span_reject\">Detail</span></a></td>\n" +
                                        "\n" +
                                        "                                                <td>\n" +
                                        "                                                    <label class=\"switch\">\n" +
