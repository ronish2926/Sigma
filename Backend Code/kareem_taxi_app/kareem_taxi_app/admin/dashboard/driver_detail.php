                          ...
                          <div class="start">
                            ...
                            <div class="start common">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status-caption-select-id">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                function retrieve_SpecificCaptainrides(search = '',captains_id) {
                    sendRequest("?action_type=retrieve&request_type=specific_captain&functionality_type=retrieve_specific_captain_rides", {
                            ...
                            if (data.code == "202") {
                                ...
                                for (var i = 0; i < list.length; i++) {
                                    ...
                                    var text = "<tr id=\"ride-type-table-row-"+n+"\">\n" +
                                        "                                                <td class=\"payment_td\"><img src=\""+cap_pic+"\" alt=\"\"></td>\n" +
                                        "                                                <td><span>"+name+"</span>\n" +
                                        "                                                </td>\n" +
                ...
                // $('#status-caption-select-id').change(function () {
                //     var status = $(this).val();
                ...
                $(document).on('change', '#status-caption-select-id', function () {
                    ...
                    sendRequest("?action_type=update&request_type=specific_captain&functionality_type=change_captain_status", {
                        status: status,
                        id: captains_id,
                    }, "POST")
                        .then((data) => {
            ...
            function deleteDocments(id) {
                ...
                sendRequest("?action_type=delete&request_type=specific_captain&functionality_type=delete_docments_pic", {
                    id:del_id,
                    path:path,
            ...
            function deleteBankPic(id) {
                ...
                sendRequest("?action_type=delete&request_type=specific_captain&functionality_type=delete_bank_pic", {
                    id:del_id,
                    path:path,
            ...
            function pag(offset,id) {
                ...
                sendRequest("?action_type=retrieve&request_type=specific_captain&functionality_type=pagination", {
                    offset:offset,
                    search:search,
                    captain_id:captains_id,
            ...
            function adddocumentedit(){
              var reg= $(".document_info_reg").val();
                ...
                sendRequest("?action_type=update&request_type=specific_captain&functionality_type=change_captain_documents", {
                    reg: reg,
                    issue: issue,
                    expire: expire,
                    front_img: front_img,
            ...
            function addbankEdit(){
                ...
                sendRequest("?action_type=update&request_type=specific_captain&functionality_type=change_captain_bank_detail", {
                    holder: holder,
                    bank_name: bank_name,
            ...
            function addcardetailEdit(){
               var cap_car_name = $(".car_name_edit").val();
                ...
                sendRequest("?action_type=update&request_type=specific_captain&functionality_type=change_captain_car_detail", {
            ...
            function carPictureAdd(){
                ...
                sendRequest("?action_type=create&request_type=specific_captain&functionality_type=insert_car_picture", {
            ...
            function adddriverDetailUpdate(){
                ...
                sendRequest("?action_type=update&request_type=specific_captain&functionality_type=driver_detail_update", {
