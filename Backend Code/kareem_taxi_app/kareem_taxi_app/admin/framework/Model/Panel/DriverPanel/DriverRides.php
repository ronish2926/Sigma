...
class DriverRides extends Constant implements Queries
{
    private $dtObject;
    private $actionType = "";
...
//        }
    ...
    public function retrieve()
    {
        ...
        if ($this->functionalityType == "retrieve_all_ride") {
...
payment_method.name as payment_method_name  , ride_order.enable , rating.rating as ride_rating
            ...
            $queryDecorator = new QueryDecorator($queryDecorator->getQuery(), new CustomQuery("0", $where_con." captain.id = '$captain_id' "));
